...
- 主播在线时前一场直播中的管理员弹幕和sc不再显示了！  
- `isadmin` 判断bug修复  
- 现在简介默认隐藏了（有些直播间简介太多影响观感）！鼠标悬浮在标题上方显示直播间简介！  

2026-08-14:  

- 更改了部分配色  
- 现在鼠标悬浮在标题和主播昵称上时会有微小的颜色变化了！  
- 动态适配系统深/浅色主题！  
- 弹幕显示重大更新！显示主播牌子等级，显示管理员标签，显示SC标签，点击观众名称进入用户主页，时间显示优化，整体配色和风格优化  
- 现在可以标选弹幕文本用复制了！  
- 现在可以翻看历史弹幕了！视角在列表最下面才会实时显示更新弹幕  
- 减少了获取弹幕延迟，弹幕显示更加实时了！（近乎实时获取）

![260814-update](./shows/260814-update.png)  
